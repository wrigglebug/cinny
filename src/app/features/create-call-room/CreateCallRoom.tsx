...
const getCreateCallRoomKindToIcon = (kind: CreateRoomKind) => {
...
type CreateCallRoomFormProps = {
  defaultKind?: CreateRoomKind;
  space?: Room;
  onCreate?: (roomId: string) => void;
};
export function CreateCallRoomForm({ defaultKind, space, onCreate }: CreateCallRoomFormProps) {
    ...
    <Box as="form" onSubmit={handleSubmit} grow="Yes" direction="Column" gap="500">
      <Box direction="Column" gap="100">
        ...
        <CreateRoomKindSelector
          ...
          disabled={disabled}
          getIcon={getCreateCallRoomKindToIcon}
        />
      </Box>
      <Box shrink="No" direction="Column" gap="100">
        ...
        <Input
          required
          before={<Icon size="100" src={Icons.VolumeHigh} />}
          name="nameInput"
          autoFocus
          size="500"
          ...
          <>
            ...
            {advance && (allowKnock || allowKnockRestricted) && (
              ...
              >
                <SettingTile
                  title="Knock to Join"
                  description="Anyone can send request to join this call room."
                  after={
                    <Switch
                      variant="Primary"
                      value={knock}
