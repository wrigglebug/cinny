...
import { Box, Icon, IconButton, Icons, Scroll, Spinner, Text, as, color, config, Modal, Overlay, OverlayBackdrop, OverlayCenter } from 'folds';
                ...
                <OverlayCenter>
                  ...
                  >
                    ...
                    >
                      <ImageViewer
                        src={imgUrl}
                        alt={prev['og:title'] || 'Preview image'}
